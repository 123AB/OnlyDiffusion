...
filename2 = "./diffusion_last_two_year_indegree/diffusion_last_two_years_fb_like_unequally_seeding/diffusion_results_{:f}_{}.txt"
filename = "./diffusion_last_two_year_indegree/diffusion_last_two_years_fb_like_equally_seeding/diffusion_results_{:f}_{}.txt"
filename_original = "./diffusion_last_two_year_indegree/diffusion_last_two_years_fb_like_original/diffusion_results_{:f}_{}.txt"

#filename2 = "./diffusion_last_year_month_fb_intensity_like_unequally_seeding/diffusion_results_{:f}_{}.txt"
#filename = "./diffusion_last_year_month_fb_intensity_like_equally_seeding/diffusion_results_{:f}_{}.txt"
#filename_original = "./diffusion_last_year_month_fb_intensity_like_original_seeding/diffusion_results_{:f}_{}.txt"
...
for ratio in ratio_list:
        ...
        if (os.path.exists(filename.format(ratio, seedNum)) == True):
            with open(filename.format(ratio, seedNum), 'r') as read_file, open(filename2.format(ratio, seedNum), 'r') as read_file_unequally, open(filename_original.format(ratio, seedNum), 'r') as read_file_original:
                ...
                for line2 in read_file_unequally:
                    ...
                    total_sum2 = df_sum_m2 + df_sum_fm2
                ...
                for line3 in read_file_original:
                    ...
                    total_sum3 = df_sum_m3 + df_sum_fm3
    ...
    #ax.stackplot(month_list,total_sum_node,total_sum_node2,total_sum_node3)
    ...
    plt.savefig('temporal_sum_spread_node_ratio_{}_{}.png'.format(ratio,seedNum_list[0]))
    plt.show()  # 显示图形
    total_sum_node = []
    total_sum_node2 = []
    total_sum_node3 = []
