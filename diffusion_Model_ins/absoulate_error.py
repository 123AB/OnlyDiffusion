...
total_sum_node2 = []
total_sum_node3 = []
ratio_list = {0.000000, 0.100000, 0.200000, 0.300000, 0.400000, 0.500000, 0.600000, 0.700000, 0.800000, 0.900000,0.100000}
    ...
    for ratio in ratio_list:
        ...
        if (os.path.exists(FILE_READ_ORIGINAL.format(ratio, seedNum)) == True):
            with open(FILE_READ_ORIGINAL.format(ratio, seedNum), 'r') as read_file,  open(FILE_READ_UNEQUALLY_SEED.format(ratio, seedNum), 'r') as read_file_unequally, open(FILE_READ_EQUALLY_SEED.format(ratio, seedNum), 'r') as read_file_equally, \
                ...
                dif_seed_ratio = abs(seed_ratio_abu - seed_ratio)
                ...
                dif_seed_ratio2 = abs(seed_ratio2_abu - seed_ratio2)
                ...
                dif_seed_ratio3 = abs(seed_ratio3_abu - seed_ratio3)
                ...
                dif_seed_ratio_list.append(dif_seed_ratio2)
