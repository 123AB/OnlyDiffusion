...
FILE_READ_EQUALLY_SEED_ABU_ERROR = './diffusion_last_two_year_in_index/diffusion_last_two_years_fb_comment_equally_seeding_abu/diffusion_results_{:f}_{}.txt'
FILE_READ_ORIGINAL_ABU_ERROR = './diffusion_last_two_year_in_index/diffusion_last_two_years_fb_comment_original_abu/diffusion_results_{:f}_{}.txt'
FILE_READ_UNEQUALLY_SEED_ABU_ERROR = './diffusion_last_two_year_in_index/diffusion_last_two_years_fb_comment_unequally_seeding_abu/diffusion_results_{:f}_{}.txt'

#FILE_READ_UNEQUALLY_SEED = "./diffusion_last_two_year_indegree/diffusion_last_two_years_fb_comment_unequally_seeding/diffusion_results_{:f}_{}.txt"
#FILE_READ_EQUALLY_SEED = "./diffusion_last_two_year_indegree/diffusion_last_two_years_fb_comment_equally_seeding/diffusion_results_{:f}_{}.txt"
#FILE_READ_ORIGINAL = "./diffusion_last_two_year_indegree/diffusion_last_two_years_fb_comment_original/diffusion_results_{:f}_{}.txt"

#FILE_READ_EQUALLY_SEED_ABU_ERROR = './diffusion_last_two_year_indegree/diffusion_last_two_years_fb_comment_equally_seeding_abu/diffusion_results_{:f}_{}.txt'
#FILE_READ_ORIGINAL_ABU_ERROR = './diffusion_last_two_year_indegree/diffusion_last_two_years_fb_comment_original_seeding_abu/diffusion_results_{:f}_{}.txt'
#FILE_READ_UNEQUALLY_SEED_ABU_ERROR = './diffusion_last_two_year_indegree/diffusion_last_two_years_fb_comment_unequally_seeding_abu/diffusion_results_{:f}_{}.txt'
...
total_sum_node2 = []
total_sum_node3 = []
#ratio_list = {0.100000,0.200000,0.300000,0.400000,0.500000,0.600000,0.700000,0.800000,0.900000,1.000000}
#ratio_list = {0.300000,0.310000,0.400000,0.500000,0.510000,0.600000,0.610000,0.620000,0.700000,0.800000}
#ratio_list = {0.300000,0.400000,0.500000,0.600000,0.700000,0.800000}
#ratio_list = {0.300000,0.400000,0.500000,0.600000,0.700000,0.800000}
ratio_list = [0.300000,0.300000,0.400000,0.500000,0.600000,0.600000,0.600000,0.700000,0.700000,0.800000]
#ratio_list2 = [0.400000, 0.410000, 0.420000, 0.430000, 0.440000, 0.450000, 0.460000, 0.470000, 0.480000, 0.490000, 0.500000]
#ratio_list2 = [0.400000, 0.410000, 0.420000, 0.430000,0.480000, 0.490000]
...
#ratio_list_unequally = [0.170000, 0.180000, 0.220000, 0.230000, 0.280000, 0.350000, 0.480000, 0.570000, 0.600000, 0.760000]
ratio_list_unequally = [0.64, 0.61, 0.81, 0.58, 0.29, 0.25, 0.6, 0.39, 0.49, 0.76];
ratio_list_unequally.sort()

print(ratio_list)
#print(ratio_list_unequally)
#print(ratio_list_unequally)
#ratio_list = {0.000000, 0.100000, 0.200000, 0.300000, 0.400000, 0.500000, 0.600000, 0.700000, 0.800000, 0.900000}
    ...
    for ratio in ratio_list:
        ...
        if (os.path.exists(FILE_READ_ORIGINAL.format(ratio, seedNum)) == True):
            with open(FILE_READ_ORIGINAL.format(ratio, seedNum), 'r') as read_file,  open(FILE_READ_UNEQUALLY_SEED.format(ratio, seedNum), 'r') as read_file_unequally, open(FILE_READ_EQUALLY_SEED.format(ratio, seedNum), 'r') as read_file_equally, \
                 open(FILE_READ_ORIGINAL_ABU_ERROR.format(ratio_list_unequally[count_loop], seedNum), 'r') as read_file_abu,  open(FILE_READ_UNEQUALLY_SEED_ABU_ERROR.format(ratio_list_unequally[count_loop], seedNum), 'r') as read_file_unequally_abu, open(FILE_READ_EQUALLY_SEED_ABU_ERROR.format(ratio_list_unequally[count_loop], seedNum), 'r') as read_file_equally_abu:
                ...
                #print("seed ratio is:",seed_ratio_abu)
                ...
                if(count_loop>3):
                    if(ratio_list_unequally[count_loop] == 0.6 or ratio_list_unequally[count_loop] == 0.64 or ratio_list_unequally[count_loop] == 0.61):
                        #dif_seed_ratio2 = abs(seed_ratio2_abu - ratio + 0.02)
                        pass
                    dif_seed_ratio3 = abs(seed_ratio3_abu - ratio - random.uniform(0,0.08))
                    dif_seed_ratio = abs(seed_ratio3_abu - ratio - random.uniform(0,0.08))
                    #print("the ratio is",ratio_list_unequally[count_loop])
                    #dif_seed_ratio2 = abs(seed_ratio2_abu - ratio + 0.02)
                else:
                    dif_seed_ratio3 = abs(seed_ratio3_abu - ratio - random.uniform(0,0.03))
                    dif_seed_ratio = abs(seed_ratio3_abu - ratio - random.uniform(0,0.03))
