...
FILE_READ_UNEQUALLY_SEED = "./diffusion_last_two_year_in_index/diffusion_last_two_years_fb_comment_unequally_seeding_abu/diffusion_results_{:f}_{}.txt"
...
ratio_list_unequally = [0.390000,0.400000, 0.430000, 0.440000, 0.450000, 0.460000, 0.470000, 0.480000, 0.490000, 0.500000,0.510000]
...
seedNum_list = [100]
#seeding_ratio_1 = [0.05,0.06,0.08,0.01,0.09,0.02,0.1,0.12,0.09,0.10,0.11]
count_loop = 0
...
for seedNum in seedNum_list:
    ...
    for ratio in ratio_list:
        ...
        if (os.path.exists(FILE_READ_ORIGINAL.format(ratio, seedNum)) == True):
            with open(FILE_READ_ORIGINAL.format(ratio, seedNum), 'r') as read_file,  open(FILE_READ_UNEQUALLY_SEED.format(ratio_list_unequally[count_loop], seedNum), 'r') as read_file_unequally, open(FILE_READ_EQUALLY_SEED.format(ratio, seedNum), 'r') as read_file_equally:
    ...
    plotting(seed_ratio_list,seed_ratio_list2,seed_ratio_list3,ratio_list_unequally,seedNum)
    seed_ratio_list = []
    seed_ratio_list2 = []
    seed_ratio_list3 = []
    target_ratio_list = []
