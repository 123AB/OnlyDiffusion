...
*/
    ...
    for (int ratio_size_len = 0; ratio_size_len<sizeof(ratio_list_like_100)/sizeof(ratio_list_like_100[0]); ratio_size_len = ratio_size_len + 1){
        ...
        for(int seed_size_len = 0; seed_size_len<sizeof(seed_size)/sizeof(seed_size[0]); seed_size_len = seed_size_len + 1){
            ...
            oss_ratio << std::fixed;
            oss_ratio << std::setprecision(2);

            oss_ratio << ratio;
            std::string strRatio = oss_ratio.str();


            //oss << "../student_preprocess/diffusion/ins_month/like_557" << ".csv";
            oss << "../student_preprocess/diffusion/ins_month/comment_557" << ".csv";
           ...
           // oss_seed << "../student_preprocess/target_hindex_temporal/diversity_month_hi_index/diversity-" << fileName << "-" << seed_size[seed_size_len] << "-" << strRatio << "-" << "220" << ".csv";
            ...
            //oss_seed << "../student_preprocess/indegree_temporal_ins/indegree_diversity_seed/diversity-" << fileName << "-" << seed_size[seed_size_len] << "-" << strRatio << "-" << "546" << ".csv";
            //oss_seed << "../student_preprocess/pagerank_temporal_ins/pagerank_diversity_seed/diversity-" << fileName << "-" << seed_size[seed_size_len] << "-" << strRatio << "-" << "546" << ".csv";
            oss_seed << "../student_preprocess/target_hindex_temporal_ins/diversity_month_hi_index_ins/diversity-" << fileName << "-" << seed_size[seed_size_len] << "-" << strRatio << "-" << "546" << ".csv";
