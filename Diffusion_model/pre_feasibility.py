...
#ratio_list_unequally = [0.480000]
ratio_list = {0.410000,0.420000,0.430000,0.440000,0.470000,0.480000,0.490000,0.510000,0.520000,0.530000}
#ratio_list = {0.490000}
...
for seedNum in seedNum_list:
    ...
    for ratio in ratio_list:
        if (os.path.exists(FILE_READ_ORIGINAL_ABU_ERROR.format(ratio, seedNum)) == True):
            with open(FILE_READ_ORIGINAL.format(ratio_list_unequally[count_loop], seedNum), 'r') as read_file,  open(FILE_READ_UNEQUALLY_SEED.format(ratio_list_unequally[count_loop], seedNum), 'r') as read_file_unequally, open(FILE_READ_EQUALLY_SEED.format(ratio_list_unequally[count_loop], seedNum), 'r') as read_file_equally, \
                 open(FILE_READ_ORIGINAL_ABU_ERROR.format(ratio, seedNum), 'r') as read_file_abu,  open(FILE_READ_UNEQUALLY_SEED_ABU_ERROR.format(ratio, seedNum), 'r') as read_file_unequally_abu, open(FILE_READ_EQUALLY_SEED_ABU_ERROR.format(ratio, seedNum), 'r') as read_file_equally_abu:
    ...
    print("seed ratio is:", seedNum)
    print("ratio is:", ratio)
    #print(dif_seed_ratio_list)
    feasibility_dif_seed_ratio_list = [i for i in dif_seed_ratio_list if i  < 0.10]
    print(len(feasibility_dif_seed_ratio_list)/len(dif_seed_ratio_list))
    feasibility_dif_seed_ratio2_list = [i for i in dif_seed_ratio2_list if i < 0.10]
    ...
    feasibility_dif_seed_ratio3_list = [i for i in dif_seed_ratio3_list if i < 0.10]
