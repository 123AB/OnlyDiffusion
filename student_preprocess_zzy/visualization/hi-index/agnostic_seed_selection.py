...
seeds = [1000]
for s in seeds:
    FILE_DIR = '../../dataset/seed_selection/remove1interaction/hi-index/HIindex_sort_{}_{}.csv'
    FILE_WRITE = '../../dataset/seed_selection/remove1interaction/hi-index/agnostic/agnostic-{}-{}-{}.csv'
