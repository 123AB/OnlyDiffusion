...
for s in seeds:
    FILE_DIR = '../../dataset/seed_selection/remove1interaction/targetpagerank/Targetpagerank_sort_{}.csv'
    FILE_WRITE = '../../dataset/seed_selection/remove1interaction/targetpagerank/parity/parity-{}-{}.csv'
