...
for s in seeds:
    for byType in range(2):
        mr_list = []
        with open("../../../../fairness/dataset/discount_factor_train/weight/weight_diversity-hindex_{}_{}.txt".format(byType, s), 'r') as read_file:
            for line in read_file:
                token = line.split(',')
        ...
        for idx, ratio in enumerate(mr_list):
            ...
            FILE_DIR = '../../../dataset/seed_selection/remove1interaction/h_index/Hindex_sort_{}.csv'
            ...
            if byType == 0: seedfile = 'hindexl'
            elif byType == 1: seedfile = 'hindexc'
