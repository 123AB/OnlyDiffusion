...
for ratio in range(100):
    ...
    for s in seeds:
        ...
        FILE_DIR = '../../../student_preprocess/indegree_temporal/indegree_data/students_indegree_comment_{}.csv'
        ...
        FILE_WRITE = '../../../student_preprocess/indegree_temporal/indegree_diversity_seed/diversity-{}-{}-{}-{}.csv'
