...
FILE_DIR = '../../../student_preprocess/indegree/students_edges_all.csv';
...
for ratio in range(11):
    ...
    for s in seeds:
        ...
        FILE_DIR = '../../../student_preprocess/indegree/students_indegree_sort_{}.csv'
        #FILE_WRITE = '../../dataset/seed_selection/remove1interaction/diversity/diversity-{}-{}-{}.csv'
        FILE_WRITE = '../../dataset/seed_selection_indegree/diversity-{}-{}-{}.csv'
