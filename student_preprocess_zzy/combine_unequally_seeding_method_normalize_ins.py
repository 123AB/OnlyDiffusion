...
file_clustering_cofficient_like = 'clustering_cofficient_data_ins/clustering_cofficient_comment.csv'
file_clustering_cofficient_comment = 'clustering_cofficient_data_ins/clustering_cofficient_like.csv'
filename = "clustering_cofficient_data_ins/clustering_cofficient_{}.csv"
filename_graph_size = "graph_size_data_ins/graph_size_data_ins.csv"
# edge type
