...
#seeds = [1, 2, 5, 10, 20, 50, 75, 100, 125, 150, 175, 200, 500, 1000]
seeds = [100, 200]
...
#for ratio in range(101):
    ...
    for s in seeds:
        ...
        #FILE_DIR = 'intensity_data/students_intensity_comment_{}.csv'
        FILE_DIR = 'intensity_data_twomonth/students_intensity_{}_{}.csv'
        #FILE_DIR = 'intensity_data_twoweek/students_intensity_{}_{}.csv'
        #FILE_DIR = 'intensity_data_week/students_intensity_{}_{}.csv'

        #FILE_WRITE = '../../dataset/seed_selection/remove1interaction/diversity/diversity-{}-{}-{}.csv'

        #FILE_WRITE = 'intensity_diversity_seed/diversity-{}-{}-{}-{}.csv'
        FILE_WRITE = 'intensity_diversity_seed_twomonth/diversity-{}-{}-{}-{}.csv'
        #FILE_WRITE = 'intensity_diversity_seed_oneweek/diversity-{}-{}-{}-{}.csv'
        #FILE_WRITE = 'intensity_diversity_seed_twoweek/diversity-{}-{}-{}-{}.csv'
