...
for blocknum in list:
    if (os.path.exists(filename.format(blocknum)) == True):
        ...
        for i in range(3):
            ...
            #OUTPUT_DIR = 'intensity_data/students_intensity_{}_{}.csv'.format(types[i],blocknum)

            OUTPUT_DIR = 'intensity_data_twomonth/students_intensity_{}_{}.csv'.format(types[i],blocknum)
            #OUTPUT_DIR = 'intensity_data_twoweek/students_intensity_{}_{}.csv'.format(types[i],blocknum)
            #OUTPUT_DIR = 'intensity_data_week/students_intensity_{}_{}.csv'.format(types[i],blocknum)
