...
weekly_degree_joined_at100 <- weekly_degree_joined[week==14,,]
weekly_degree_joined_at150 <-  weekly_degree_joined[week==28,,]
  
weekly_degree_joined_at200 <- weekly_degree_joined[week==42,,]
weekly_degree_joined_at250 <- weekly_degree_joined[week==56,,]
weekly_degree_joined_at300 <- weekly_degree_joined[week==70,,]
...
weekly_intensity_joined_at100 <- weekly_intensity_joined[week==14,,]
weekly_intensity_joined_at200 <- weekly_intensity_joined[week==42,,]
weekly_intensity_joined_at300 <- weekly_intensity_joined[week==70,,]
...
get_duration_avr_male <- function(weekly = weekly_gender_people_group_males){
  weekly_prob_top10_avr_tep <- weekly[order(week), .(n = .N, average_intensity = sum(rec_intensity)/71)]
...
get_duration_avr_male <- function(weekly = weekly_gender_people_group_males){
  weekly_prob_top100_avr_tep <- weekly[order(week), .(n = .N, average_intensity = sum(rec_intensity)/71)]
...
get_duration_avr_female <- function(weekly = weekly_gender_people_group_females){
  weekly_prob_top300_avr_tep <- weekly[order(week), .(n = .N, average_intensity = sum(rec_intensity)/71)]
...
get_duration_avr_female <- function(weekly = weekly_gender_people_group_females){
  weekly_prob_top10_avr_tep <- weekly[order(week), .(n = .N, average_indegree = sum(indegree)/71)]
  ave_tep_data <- as.numeric(unlist(weekly_prob_top10_avr_tep[1,2]))
...
get_duration_avr_female <- function(weekly = weekly_gender_people_group_females){
  weekly_prob_top100_avr_tep <- weekly[order(week), .(n = .N, average_indegree = sum(indegree)/71)]
  ave_tep_data <- as.numeric(unlist(weekly_prob_top100_avr_tep[1,2]))
...
get_duration_avr_female <- function(weekly = weekly_gender_people_group_females){
  weekly_prob_top300_avr_tep <- weekly[order(week), .(n = .N, average_indegree = sum(indegree)/71)]
  ave_tep_data <- as.numeric(unlist(weekly_prob_top300_avr_tep[1,2]))
