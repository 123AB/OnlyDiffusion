...
weekly_degree_joined_at100 <- weekly_degree_joined[week==10,,]
weekly_degree_joined_at150 <-  weekly_degree_joined[week==15,,]
  
weekly_degree_joined_at200 <- weekly_degree_joined[week==20,,]
weekly_degree_joined_at250 <- weekly_degree_joined[week==25,,]
weekly_degree_joined_at300 <- weekly_degree_joined[week==30,,]
...
weekly_degree_joined_at100[,.(min_e = min(week_elapse)),by = source_id]
  ...
  # no gender
ggplot(degree_asweek_at100, aes(x =week_elapse, y = outdegree_mean))+
  geom_line(lwd = 1)+theme_bw()+xlab("Week Joined")+ylab("Mean Outdegree")+
    # geom_smooth(method = "lm", formula = y~x,se = F)+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))+
  labs(color = "gender")
ggplot(degree_asweek_at200, aes(x =week_elapse, y = outdegree_mean))+
  geom_line(lwd = 1)+theme_bw()+xlab("Week Joined")+ylab("Mean Outdegree")+
    # geom_smooth(method = "lm", formula = y~x,se = F)+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))
ggplot(degree_asweek_at300, aes(x =week_elapse, y = outdegree_mean))+
  geom_line(lwd = 1)+theme_bw()+xlab("Week Joined")+ylab("Mean Outdegree")+
    # geom_smooth(method = "lm", formula = y~x,se = F)+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))
  
  # with gender
ggplot(degree_asweek_at100, aes(x =week_elapse, y = outdegree_mean, color = gender_source))+
  geom_line(lwd = 1)+theme_bw()+xlab("Week Joined")+ylab("Mean Outdegree")+
    # geom_smooth(method = "lm", formula = y~x,se = F)+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))+
  labs(color = "gender")+ggtitle("Observed at week 100")
ggsave("active_elapse100.jpg")
ggplot(degree_asweek_at150, aes(x =week_elapse, y = outdegree_mean, color = gender_source))+
  geom_line(lwd = 1)+theme_bw()+xlab("Week Joined")+ylab("Mean Outdegree")+
    # geom_smooth(method = "lm", formula = y~x,se = F)+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))+
...
ggplot(degree_asweek_at200, aes(x =week_elapse, y = outdegree_mean, color = gender_source))+
  geom_line(lwd = 1)+theme_bw()+xlab("Week Joined")+ylab("Mean Outdegree")+
    # geom_smooth(method = "lm", formula = y~x,se = F)+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))+
  labs(color = "gender")+ggtitle("Observed at week 200")
ggsave("active_elapse200.jpg")
ggplot(degree_asweek_at250, aes(x =week_elapse, y = outdegree_mean, color = gender_source))+
  geom_line(lwd = 1)+theme_bw()+xlab("Week Joined")+ylab("Mean Outdegree")+
    # geom_smooth(method = "lm", formula = y~x,se = F)+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))+
  labs(color = "gender")+ggtitle("Observed at week 250")
ggsave("active_elapse250.jpg")
ggplot(degree_asweek_at300, aes(x =week_elapse, y = outdegree_mean, color = gender_source))+
  geom_line(lwd = 1)+theme_bw()+xlab("Week Joined")+ylab("Mean Outdegree")+
    # geom_smooth(method = "lm", formula = y~x,se = F)+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))+
...
weekly_intensity_joined_at100 <- weekly_intensity_joined[week==10,,]
weekly_intensity_joined_at200 <- weekly_intensity_joined[week==20,,]
weekly_intensity_joined_at300 <- weekly_intensity_joined[week==30,,]
...
ggplot(intensity_asweek_at100, aes(x =week_elapse, y = intensity_mean, color = gender_source))+
  geom_line(lwd = 0.8)+
...
ggplot(intensity_asweek_at200, aes(x =week_elapse, y = intensity_mean, color = gender_source))+
  geom_line(lwd = 0.8)+
    # geom_line(data = intensity_asweek_rank_rm20, color = "black")+
  theme_bw()+xlab("Week Joined")+ylab("Mean Sent Intensity")+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))+
...
ggplot(intensity_asweek_at300, aes(x =week_elapse, y = intensity_mean, color = gender_source))+
  geom_line(lwd = 0.8)+
    # geom_line(data = intensity_asweek_rank_rm20, color = "black")+
  theme_bw()+xlab("Week Joined")+ylab("Mean Sent Intensity")+
  theme(axis.text = element_text(size = 12), axis.title  = element_text(size = 14), legend.title = element_text(size=12))+
