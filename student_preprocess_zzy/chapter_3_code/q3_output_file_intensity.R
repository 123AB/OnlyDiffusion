...
activity_week <-  data_filter3[, length(which(rec_intensity == rec_intensity)),by = .(target_id)]
...
write.csv(combine_data, "D:\\R_test\\social\\z_master_thesis\\q5_output_active_intensity.csv", row.names = FALSE)
